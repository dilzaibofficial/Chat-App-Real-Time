...
## 📌 Project Overview
This project consists of a **Client**, **Server**, and a **Preview** folder:
- **Client:** Install dependencies with `npm install` and run with `npm start`.
- **Server:** Install dependencies with `npm install` and run with `node server`.
- **Preview:** Contains GIFs showcasing the application.
...
1. Clone the repository:
   ```sh
   git clone https://github.com/dilzaibofficial/project-name.git
   ```
